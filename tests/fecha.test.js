...
test("formatFecha tolera formato con hora", () => {
  assert.equal(formatFecha("2026-08-16 18:30"), "16 de agosto de 2026");
  assert.equal(formatFecha("2026-08-01 10:00"), "1 de agosto de 2026");
});
